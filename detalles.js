$(window).on('load',function(){
           ...
           fetch(ip + '/api/detalles.php?detalle=' + localStorage.getItem('id_c'))
               .then(function (res) {
                   return res.json();
               })
               .then(function (imagenes) {
                 ...
                 <div class="col-xs-3">
                     ...
                     <a href="https://wa.me/521${imagen.ClienteTel}"><img style="width:30px; margin:10px;" src="img/whatsapp.png"
                             alt="User Image"></a>
                 </div>
                 <div class="col-xs-3">
           
                     <a href="tel:${imagen.ClienteTel}"><img style="width:30px; margin:10px;" src="img/icono_cel.png"
                             alt="User Image"></a>
                 </div>
                 <div class="col-xs-3">
                     <a href="mailto:${imagen.ClienteCorreo}"><img style="width:30px; margin:10px;" src="img/icono_mail.png"
                             alt="User Image"></a>
                 </div>
                 ...
                 <div class="col-xs-6" style="width:100%; color:black; font-size:16px;">
                     ...
                     <span style="color:#66CB79; font-size:12px; border-bottom:1px solid black;">Correo:
                         ${imagen.ClienteCorreo}</span><br>
                     <span style="color:#C0CB66; font-size:20px; border-bottom:1px solid black;">Telefono:
                         ${imagen.ClienteTel}</span><br>
                     <p>${imagen.Mensaje}</p>
                     ${prod}
                 </div>
             </div>
